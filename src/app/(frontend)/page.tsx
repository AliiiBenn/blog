  ...
  return (
    <div className="bg-background py-8 sm:py-12 lg:py-16 relative">
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-[calc(100%-1rem)] sm:max-w-5xl max-h-[80rem] border-x border-t border-border px-4 sm:px-6 lg:px-8 pt-24 pb-12 relative overflow-hidden">
      ...
      {/* Spacer */}
      <section className="mx-auto max-w-[calc(100%-1rem)] sm:max-w-5xl h-4 border-x border-t border-border" />

      {/* Latest Posts - Terminal Style */}
      <section className="mx-auto max-w-[calc(100%-1rem)] sm:max-w-5xl border-x border-t border-border bg-background">
        <PostGrid posts={recentPosts} />
      </section>

      {/* Newsletter CTA - Terminal Style */}
      <section className="mx-auto max-w-[calc(100%-1rem)] sm:max-w-5xl border-x border-t border-b border-border bg-background px-4 py-12 sm:px-6 lg:px-8 relative">
        ...
        <div className="border-2 border-dashed border-border bg-muted/20 p-6 sm:p-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mb-4 font-mono text-xs">
              <div className="inline-flex items-center gap-2 border border-border bg-muted px-2 sm:px-3 py-2 max-w-full overflow-hidden">
